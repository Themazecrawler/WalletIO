  ...
  useGSAP(
    () => {
      ...
      const build = () => {
        ...
        // Safe manual element split to mimic SplitText without paid license requirement
        el.innerHTML = '';
        const charsList: HTMLElement[] = [];

        // We split words by whitespace and preserve words/characters
        const words = text.split(/(\s+)/);
        words.forEach(word => {
          if (word.trim() === '') {
            const spaceSpan = document.createElement('span');
            spaceSpan.className = 'shuffle-space';
